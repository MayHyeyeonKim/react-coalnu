...
export const WeatherCard = ({ locationWeather, unit, index, setSelectedLocationWeather, onRemove }: WeatherCardProps) => {
    ...
    >
      ...
      >
        <span className="card-topline">
          ...
          {!onRemove && <span className="card-arrow" aria-hidden="true">↗</span>}
        </span>
